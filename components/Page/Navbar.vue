...
const menus = computed((): IMenuItem[] => [
  { type: 'link', text: 'blan', route: { name: 'blank' } },
  { type: 'link', text: 'tes', route: { name: 'test' } },
  { type: 'link', text: 'abou', route: { name: 'about' } },
  { type: 'link', text: 'settin', route: { name: 'setting' } },
  {
    type: 'button',
    text: 'nav',
    ...
    <template #options="{ toggleOptions }">
      <ActionSheet @onClose="toggleOptions(false)">
        <ActionSheetBody>
          ...
          <div class="mt-6 text-sm font-bold capitalize">change</div>
          <div class="mt-2">
            <ThemeSwitcher type="select-box" />
          </div>
          <div class="mt-6 text-sm font-bold capitalize">hange lang</div>
          <div class="mt-2">
